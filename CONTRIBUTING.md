# Contributing to brain-wiki

Thanks for your interest in improving this plugin. brain-wiki is a small, focused project; contributions that match its philosophy land quickly.
...
Contributions are accepted on the public canonical repo. Fork [`chulsooiam/brain-wiki`](https://github.com/chulsooiam/brain-wiki) on GitHub, then:

```bash
git clone https://github.com/<your-username>/brain-wiki.git
cd brain-wiki
git checkout -b your-feature-name
```

> ℹ️ The public repo (`chulsooiam/brain-wiki`) is the canonical source of truth. Raise all PRs against it. AI Marketing Hub Pro members working from the early-access mirror (`chulsooiam/brain-wiki`) should target the public canonical too, so contributions land in one place.
