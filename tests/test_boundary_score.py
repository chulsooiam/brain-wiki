...
def test_included_rejects_symlink():
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            ...
            # symlinks (WinError 1314). The production check this test covers
            # is platform-independent; skip rather than fail on such hosts.
            print("SKIP symlink rejection (symlinks unavailable on this host)")
            return
