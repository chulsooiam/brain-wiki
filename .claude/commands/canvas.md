...
> Project-scope copy of `commands/canvas.md` so a cloned vault works without the
...
Read the `canvas` skill (`skills/canvas/SKILL.md` at the vault root). Then run the operation matching the user's command.
