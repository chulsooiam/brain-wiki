...
> Project-scope copy of `commands/autoresearch.md` so a cloned vault works without the
...
Read the `autoresearch` skill (`skills/autoresearch/SKILL.md` at the vault root). Then run the research loop.
