...
```bash
# Codex CLI
ln -s "$(pwd)/skills" ~/.codex/skills/brain-wiki

# OpenCode
ln -s "$(pwd)/skills" ~/.opencode/skills/brain-wiki
```
...
- Plugin homepage (public canonical): https://github.com/chulsooiam/brain-wiki
