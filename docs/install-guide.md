# brain-wiki: Install Guide

**Claude + Obsidian Knowledge Companion**
Version 1.9.2 · public canonical: [github.com/chulsooiam/brain-wiki](https://github.com/chulsooiam/brain-wiki) · community early-access mirror (Pro): [AI Marketing Hub org](https://github.com/AI-Marketing-Hub)

> ℹ️ The install commands below use the **public open-source** URLs (`chulsooiam/brain-wiki`), recommended for everyone and requiring no membership. [AI Marketing Hub Pro](https://www.skool.com/ai-marketing-hub-pro) members who want early access to in-development features can swap every `chulsooiam/brain-wiki` for `chulsooiam/brain-wiki` and the plugin slug `brain-wiki@chulsooiam-brain-wiki` for `brain-wiki@chulsooiam-brain-wiki`.
...
brain-wiki is a Claude Code plugin + Obsidian vault that builds and maintains a persistent, compounding knowledge base. Every source you add gets processed into cross-referenced wiki pages. Every question you ask pulls from everything that has been read. Knowledge compounds like interest.
...
- **GitHub (public canonical)**: [github.com/chulsooiam/brain-wiki](https://github.com/chulsooiam/brain-wiki)
- **Issues**: [github.com/chulsooiam/brain-wiki/issues](https://github.com/chulsooiam/brain-wiki/issues)
